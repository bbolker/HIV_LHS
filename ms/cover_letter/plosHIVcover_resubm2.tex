...
\response{
We have changed the wording, and corrected a typo (the first value should have been 0.84 --- sorry!) As we say in our responses above, we have added more information about the choice of $r$, $I(0)$, $\alpha(0)$ in our sensitivity analyses (Figure 1).
}
