...
(both with a minimum of $\approx$ 7.25 years to progress to AIDS), 
...
(In the main text we focus on the model with non-instantaneous pair formation, extra-partnership contact (``pairform+epc'') and heterogeneous sexual activity, which we denote as ``hetero''; Figure S4 in Appendix S2 presents results on the effect of adding heterogeneity to other model variants.)
...
\todo{discussion of effect of heterogeneity and vital dynamics here (referring to supp material)}
