...
ratios $c_u/c_w$ and $c_e/c_w$ (see Appendix S1). 
...
of mean \Lspvl\ of 3.0, standard deviation of \Lspvl\ of 0.2, and epidemic size of $10^{-4}$. After each run, the initial exponential growth rate is calculated. Then the parameters are scaled as described above so that the initial exponential growth rate is scaled to 0.04, a value that approximates the growth rates of Shirreff \etal's original models.
...
for the implicit model. (Appendix S2 
presents plots showing univariate summaries
...
\bibitem{berngruber_spatial_2015}
