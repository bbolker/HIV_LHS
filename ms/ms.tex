...
Although virulence dynamics are sensitive to initial conditions, we are still able to achieve similar qualitative dynamics dynamics across a range of parameters. 
For fair comparison, we hold them constant throughout our simulations.}
\label{fig:panel3}
\end{figure}
