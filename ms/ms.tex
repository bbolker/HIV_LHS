...
Surprisingly, the biggest differences are not between the simplest
and the most complex contact structures, but between the
...
human sexual behaviour, but leave out apparently insignificant
details such as extra-pair contact. If partial complexity
