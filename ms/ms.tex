...
to higher virulence). Although the speed of virulence evolution varies, leading to wide variation in the peak SPVL (ranging from \todo{XX} to \todo{YY})), virulence peaks in all models between 200 and 300 years.
