...
Since some parameters in our sampling process (see next section)
lead to very low equilibrium prevalence, we switched to 
$I(0)=10^{-4}$ for the remainder of our analysis.
