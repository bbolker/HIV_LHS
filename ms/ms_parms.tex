...
\begin{table}[ht]
\caption{Parameter ranges/values.  Note that $c$ and $\rho$ values are doubled from \champr\  because we keep track of individuals, while they keep track of couples. Starred (*) parameters (used in Figure~\ref{fig:panel3}) are from \shir.}
\centering
