...
The most striking aspect of the univariate comparisons in Figure~\ref{fig:unidist}
is the similarity of the simplest (random mixing) and the most complex
(pair formation with extra-pair contact) models,

\emph{why implicit = pair formation? when we increased the unadjusted partnership
mixing rates, the two models started to look different; so they may just be
at some lower bound ...}
...
\item fig 4. add legend, maybe transparent
