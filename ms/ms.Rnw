...
can't match both R0 and r? Can we match r exactly?}. (We're matching epidemic curve, not virulence curve!)  
 ...
 Throughout Fig 1 we're using Shirreff's parameters (Beta1 = 2.76, Duration1 = 0.25, Beta3 = 0.76, Duration3 = 0.75, cmeanbase = 1.25, alphaDist = c(min = 2, max = 7,  delta = 0.1))
