...
pairs plot: instswitch +epc is the most different from others
uncoupled mixing rate 1/5 to 5: rate of uncoupled contact relative
to within-pair contact.  If it were much lower instswitch+epc would
look more like instswitch *without* epc
(uncoupled mixing acts like random mixing)
