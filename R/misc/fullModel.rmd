...
microbenchmark(
tmpa = c(unname(g2(0, unlist(yini4), expand(HIVpars.mean))$dI)),
tmpb = c(unname(model2(expand(HIVpars.mean), infection = TRUE, mortality = TRUE)(0, unlist(yini4), expand(HIVpars.mean))[[1]][4:66]))
)
