\definecolor{blue2}{RGB}{61, 22, 218}
\definecolor{red2}{RGB}{203, 18, 18}
...
\newcommand{\instswitchnoepcinf}{
	\draw[->, blue2, dashed, very thick] (SI)
		to [bend right=45] (SItoII);
}

\newcommand{\instswitchepcinf}{
	\draw[->, red2, dashed, very thick] (SI)
		to [bend left=45] (SStoSI);
	\draw[->, red2, dashed, very thick] (II)
...
\newcommand{\pairformepcinf}{
	...
	\draw[->, red2, dashed, very thick] (I)
		to  (SItoII);
	\draw[->, red2, dashed, very thick] (II.south)
...
% http://tex.stackexchange.com/questions/40388/avoid-arrow-crossing-over-blocks-in-flow-chart
         \draw[->, red2, dashed, very thick] plot [smooth, tension=0.4] coordinates
            { (II.north) ([xshift=0.2cm,yshift=0.2cm]I.north east) 
              ([xshift=-0.5cm,yshift=0.2cm]I.north west) 
              ([yshift=0.25cm]StoI) }
              to (StoI) ;

            \draw[->, red2, dashed, very thick] plot [smooth] coordinates {
