...
\newcommand{\instswitchboxes}{
	...
	\node(pool)[compartment, very thick, above = 10mm of SI, text width = 40mm, align = center, draw = black, top color = white, bottom color = white, dotted]{temporary mixing pool};
}
